...
Dokud není na tomhle Macu nastavené OneDrive (Addvery M365), SHARED_DIR
míří do lokální složky. Jakmile bude OneDrive nainstalované a přihlášené,
stačí přepsat SHARED_DIR na jeho cestu, např.:
    Path.home() / "Library/CloudStorage/OneDrive-Addvery/Prepisy-schuzek"
"""
import json
...
def ensure_speaker_map_template(meeting_id: str, segments: list[dict]) -> None:
    ...
    print("   Vyplň jména a spusť: python3 apply_speaker_names.py " + meeting_id)
